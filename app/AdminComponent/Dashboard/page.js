...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    const totalUsers = async () => {
      try {
        const res = await axios.post('http://localhost:8080/AdminComponent/totalUsers', {}, { withCredentials: true });
  ...
  useEffect(() => {
    const totalAmount = async () => {
      try {
        const res = await axios.post('http://localhost:8080/AdminComponent/totalamount', {}, { withCredentials: true });
  ...
  useEffect(() => {
    const totalCourses = async () => {
      try {
        const res = await axios.post('http://localhost:8080/AdminComponent/totalcourses', {}, { withCredentials: true });
