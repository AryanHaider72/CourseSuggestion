...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    const totalUsers = async () => {
      try {
        const res = await axios.post(' /AdminComponent/totalUsers', {}, { withCredentials: true });
  ...
  useEffect(() => {
    const totalAmount = async () => {
      try {
        const res = await axios.post(' /AdminComponent/totalamount', {}, { withCredentials: true });
  ...
  useEffect(() => {
    const totalCourses = async () => {
      try {
        const res = await axios.post(' /AdminComponent/totalcourses', {}, { withCredentials: true });
